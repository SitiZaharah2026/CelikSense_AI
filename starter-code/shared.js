...
const CS_LANG = {
  en: {
    ...
    a4_name: 'Dyslexia / Down Syndrome',
    a4_desc: 'Dyslexia-friendly fonts, colour overlays, reading ruler, and visual mind maps — or simplified language, story board &amp; vocab drill for Down Syndrome learners.',
  ...
  ms: {
    ...
    a4_name: 'Disleksia / Sindrom Down',
    a4_desc: 'Fon mesra disleksia, lapisan warna, pembaris bacaan, dan peta minda visual — atau bahasa dipermudahkan, papan cerita &amp; latih tubi kosa kata untuk pelajar Sindrom Down.',
    ...
    agent_sign_badge:        'Sokongan Deaf',
