...
const CS_LANG = {
  en: {
    ...
    learner_deaf_desc:     'MSL/BIM sign cards, visual reading modes, and captioned content support.',
    ...
    learner_deaf_agent:    'Sign Language Agent',
  ...
  ms: {
    ...
    learner_deaf_desc:     'Kad isyarat MSL/BIM, mod bacaan visual, dan sokongan kandungan bertakarir.',
    ...
    learner_deaf_agent:    'Ejen Bahasa Isyarat',
